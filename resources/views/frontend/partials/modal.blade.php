                            ...
                            <div class="product-small-image-list quickview-product-small-image-list">
                                <div class="nav small-image-slider quickview-small-image-slider" role="tablist">
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="single-slide-tab-quick-1" href="#single-slide-quick-1">
                                            <img src="{{ asset('frontend/assets/images/single-product-slider/01.jpg') }} "
                                                                                                                             class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="single-slide-tab-quick-2" href="#single-slide-quick-2">
                                            <img src="{{ asset('frontend/assets/images/single-product-slider/02.jpg') }} "
                                                                                                                             class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="single-slide-tab-quick-3" href="#single-slide-quick-3">
                                            <img src="{{ asset('frontend/assets/images/single-product-slider/03.jpg') }} "
                                                                                                                             class="img-fluid" alt=""></a>
                                    </div>
                                    <div class="single-small-image img-full">
                                        <a data-toggle="tab" id="single-slide-tab-quick-4" href="#single-slide-quick-4">
                                            <img src="{{ asset('frontend/assets/images/single-product-slider/04.jpg') }} "
                                                                                                                             alt=""></a>
                                    </div>
                                </div>
                            </div>
